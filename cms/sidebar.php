  <aside class="main-sidebar sidebar-dark-warning elevation-4" style="background-color: #900C3F">
    <div class="dropdown" style="background-color: #900C3F">
   	<a href="./" class="brand-link" style="background-color: #0000FF">
    ...
    <div class="sidebar pb-4 mb-4" style="background-color: #0000FF">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_carrier">
              <i class="nav-icon fas fa-building"></i>
              <p>
                Carriers
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_carrier" class="nav-link nav-new_carrier tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=carrier_list" class="nav-link nav-carrier_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
