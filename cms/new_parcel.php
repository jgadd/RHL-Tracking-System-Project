...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="checkbox" name="type" id="dtype" <?php echo isset($type) && $type == 1 ? 'checked' : '' ?> data-bootstrap-switch data-toggle="toggle" data-on="Deliver" data-off="Recieve" class="switch-toggle status_chk" data-size="xs" data-offstyle="info" data-width="5rem" value="1">
              <small>Deliver = Deliver to Recipient Address</small>
              <small>, Recieve = Recieve Package</small>
            </div>
          </div>
     ...
     <div>
      ...
      <div class="form-group">
       <label for="" class="control-label">Package Description</label>
